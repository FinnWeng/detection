...
def serialize_example(feature0, feature1,feature2, feature3,feature4, feature5,feature6, feature7):
    ...
    feature = {
        ...
        "class":  _bytes_array(feature3),
        "xmax":  _bytes_array(feature4),
        "xmin":  _bytes_array(feature5),
        "ymax":  _bytes_array(feature6),
        "ymin":  _bytes_array(feature7),
    }
...
def pretrain_tfrecord_generation(tfr_fname, id_array, height_array,width_array,class_array,xmax_array,xmin_array,ymax_array,ymin_array):
    # load data2
    with tf.io.TFRecordWriter(tfr_fname) as writer:
        ...
        # for i in range(100):
            ...
            example = serialize_example(id_tensor, height_tensor, width_tensor, class_tensor,xmax_tensor,xmin_tensor,ymax_tensor,ymin_tensor)
...
def deserialized(input_dict):
    ...
    return id_tensor, height_tensor, width_tensor, class_tensor,xmax_tensor,xmin_tensor,ymax_tensor,ymin_tensor